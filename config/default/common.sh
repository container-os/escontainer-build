...
USERNAME=escore
PASSWORD=escore
SERVER_OS_REPO=http://${USERNAME}:${PASSWORD}@${SERVER}/ESCore/CentOS/7.3.1611/os/x86_64/
SERVER_UPDATES_REPO=http://${USERNAME}:${PASSWORD}@${SERVER}/ESCore/CentOS/7.3.1611/updates/x86_64/
SERVER_EASYSTACK_REPO=http://${USERNAME}:${PASSWORD}@${SERVER}/ESCore/CentOS/7.3.1611/easystack/x86_64/
