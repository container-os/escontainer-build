...
class Guest(object):
    ...
    def _generate_xml(self, bootdev, installdev, kernel=None, initrd=None,
        ...
        if self.tdl.arch == "aarch64":
            self.lxml_subelement(osNode, "nvram", "/var/lib/libvirt/qemu/nvram/centos-7-aarch64_VARS.fd")
            self.lxml_subelement(osNode, "loader", "/usr/share/AAVMF/AAVMF_CODE.fd", {'readonly':'yes', 'type':'pflash'})
            self.lxml_subelement(osNode, "boot", None, {'dev':'hd'})
