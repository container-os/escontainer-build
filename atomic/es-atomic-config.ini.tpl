...
# Base repository
yum_baseurl = http://escore:escore@mirror.easystack.cn/ESCL/{{ ESCLOUD_VER }}/os/x86_64
...
lorax_additional_repos = http://escore:escore@mirror.easystack.cn/ESCL/{{ ESCLOUD_VER }}/os/x86_64, http://escore:escore@mirror.easystack.cn/ESCL/{{ ESCLOUD_VER }}/updates/x86_64/
